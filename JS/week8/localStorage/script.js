...
function getFromLocalStorage(key) {
  ...
  try {
    //yritä muuntaa teksti JSON-olioksi
...
localStorage.clear();//yhjentää kaiken tallennetun datan.
console.log("LocalStorage tyhjenetty.");
}
clearLocalStorage();//kutsutaan funktiota

//Tarkistetaan, että localStorage on tyhjä
if (localStorage.length === 0){//palauttaa 0, jos localStorage on tyhjä.


    console.log("Vahvistus: LocalStorage on tyhjä.")
}else {
    console.log("LocalStorage EI ole tyhjä. Tallennetut avaimet:", Object.keys(localStorage));//näyttää kaikki jäljellä olevat avaimet (jos niitä on).
